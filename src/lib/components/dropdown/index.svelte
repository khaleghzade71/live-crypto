...
<div class="max-w-md m-auto">
    <label
        for="countries"
        class="w-1/3 block text-sm font-medium text-gray-300 whitespace-nowrap"
        >{Inputlabel}</label
    >
    <div
        class="mt-1 bg-blue-50 max-h-12 rounded-md shadow-md p-2 flex items-center"
    >
        <svg
    ...
    <div class="relative">
        {#if showOptions && options.length}
            <div
                tabindex="0"
                class="absolute top-0 w-full z-50 bg-white border mt-1 rounded-md shadow-md"
            >
                <ul class="py-1">
